...
(function refreshWarmPortfolioStyling() {
  ...
  if (themeMeta) {
    themeMeta.setAttribute("content", "#F5F0E8");
  }
  ...
  style.textContent = `
    ...
    .site-header {
      background: rgba(var(--color-bg-rgb), 0.9) !important;
      border-bottom-color: rgba(220, 210, 196, 0.9) !important;
    }

    .site-header.is-scrolled {
      background: rgba(var(--color-surface-rgb), 0.94) !important;
      box-shadow: 0 14px 42px rgba(69, 43, 31, 0.07) !important;
    }
    ...
    .tools-row li,
    .case-tags li {
      background: rgba(var(--color-surface-rgb), 0.72) !important;
    }
    ...
    .eyebrow::before {
      ...
      box-shadow: 36px 0 0 -2px var(--color-accent);
    }
    ...
    .page-hero::before,
    .case-hero::before {
      border-color: rgba(var(--color-accent-rgb), 0.13) !important;
    }
    ...
    .case-hero::after {
      background:
        linear-gradient(90deg, rgba(var(--color-accent-rgb), 0.65), transparent 70%),
        repeating-linear-gradient(90deg, transparent 0 34px, rgba(var(--color-accent-rgb), 0.22) 34px 35px, transparent 35px 70px) !important;
    ...
    .screenshot-panel,
    .process-step {
      background: linear-gradient(180deg, rgba(var(--color-surface-rgb), 0.96), rgba(255, 248, 239, 0.86)) !important;
    }

    .hero-accent::before,
    .hero-accent::after,
    main > section:not(.cta-section)::after,
    #services::before,
    #work::after {
      border-color: rgba(var(--color-accent-rgb), 0.14) !important;
    }
    ...
    .section-ruled {
      background:
        linear-gradient(90deg, transparent 0 49.92%, rgba(var(--color-accent-rgb), 0.05) 49.92% 50.08%, transparent 50.08% 100%),
        radial-gradient(circle at 8% 18%, rgba(var(--color-accent-rgb), 0.055) 0 1px, transparent 1.5px),
    ...
    .cta-section {
      background:
        radial-gradient(circle at 18% 22%, rgba(var(--color-accent-rgb), 0.2) 0 1px, transparent 1.5px),
        linear-gradient(135deg, rgba(var(--color-accent-rgb), 0.16), transparent 28%),
    ...
    .cta-section::before {
      ...
      background: linear-gradient(135deg, transparent 0 48%, rgba(var(--color-accent-rgb), 0.35) 48% 48.25%, transparent 48.25% 100%);
      pointer-events: none;
    }
    ...
    .project-preview img {
      filter: grayscale(0.88) sepia(0.12) contrast(1.02) saturate(0.9) !important;
    }

    .project-card:hover .project-preview::before,
    .project-card:focus-within .project-preview::before {
    ...
    .channel-card:focus-visible .channel-icon,
    .channel-card:hover .channel-mark,
    .channel-card:focus-visible .channel-mark {
      background: var(--color-accent) !important;
      border-color: var(--color-accent) !important;
      color: var(--color-on-dark) !important;
    }
